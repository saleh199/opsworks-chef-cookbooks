node[:deploy].each do |application, deploy|
  ruby_block "database_config" do
    block do
      ...
      file.insert_line_if_no_match("/'default' => env('DB_CONNECTION'),/", "default' => 'mysql',")
      ...
      file.insert_line_if_no_match("/'database' => env('MYSQL_DB_USERNAME'),/", "default' => 'root',")
      file.insert_line_if_no_match("/'database' => env('MYSQL_DB_PASSWORD'),/", "default' => '0verEst@te',")
      file.write_file
    end
  end
end
